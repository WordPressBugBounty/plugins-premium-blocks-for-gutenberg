...
if (! function_exists('rplg_urlopen')) {
    ...
    function _rplg_fopen_urlopen($url, $postdata, $headers, &$response)
    {
        ...
        $raw_headers = function_exists('http_get_last_response_headers')
            ...
            : $http_response_header; // phpcs:ignore PHPCompatibility.Variables.RemovedPredefinedGlobalVariables.http_response_headerDeprecated

        $response_header_array = explode(' ', $raw_headers[0], 3);
        ...
        $resp_headers = array_slice($raw_headers, 1);

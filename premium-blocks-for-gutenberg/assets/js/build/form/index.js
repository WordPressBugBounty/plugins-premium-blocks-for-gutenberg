...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"version":"0.1.0","name":"premium/form-checkbox","title":"Form Checkbox","description":"Create a form checkbox.","category":"premium-blocks","keywords":["checkbox"],"parent":["premium/form","premium/container","premium/section"],"attributes":{"blockId":{"type":"string"},"required":{"type":"boolean","default":false},"label":{"type":"string","default":"Checkbox"},"items":{"type":"array","default":[{"label":"Checkbox Name 1","value":"checkbox-value-1","checked":false}]},"name":{"type":"string"}},"editorScript":"pbg-blocks-js","editorStyle":"premium-blocks-editor-css"}');
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"version":"0.1.0","name":"premium/form-hidden","title":"Form Hidden","description":"Create a form hidden.","category":"premium-blocks","keywords":["hidden"],"parent":["premium/form","premium/container","premium/section"],"attributes":{"blockId":{"type":"string"},"name":{"type":"string","default":"Hidden Field Name"},"value":{"type":"string","default":""}},"editorScript":"pbg-blocks-js","editorStyle":"premium-blocks-editor-css"}');
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"version":"0.1.0","name":"premium/form-name","title":"Form Name","description":"Create a form name.","category":"premium-blocks","keywords":["name"],"parent":["premium/form","premium/container","premium/section"],"attributes":{"blockId":{"type":"string"},"autoComplete":{"type":"string","default":"off"},"required":{"type":"boolean","default":true},"placeholder":{"type":"string","default":"Name"},"label":{"type":"string","default":"Name"},"name":{"type":"string"},"showIcon":{"type":"boolean","default":false},"imageID":{"type":"string"},"imageURL":{"type":"string"},"iconTypeSelect":{"type":"string","default":"icon"},"selectedIcon":{"type":"string","default":"dashicons admin-site"},"lottieURl":{"type":"string"},"loop":{"type":"boolean","default":true},"reversedir":{"type":"boolean","default":false},"svgUrl":{"type":"string","default":""},"icons":{"type":"array","default":[{"size":"50","width":"2","title":"","style":"default"}]}},"editorScript":"pbg-blocks-js","editorStyle":"premium-blocks-editor-css"}');
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"version":"0.1.0","name":"premium/form-textarea","title":"Form Textarea","description":"Create a form textarea.","category":"premium-blocks","keywords":["textarea"],"parent":["premium/form","premium/container","premium/section"],"attributes":{"blockId":{"type":"string"},"autoComplete":{"type":"string","default":"off"},"required":{"type":"boolean","default":false},"placeholder":{"type":"string","default":"Enter your message"},"label":{"type":"string","default":"Message"},"name":{"type":"string"},"showIcon":{"type":"boolean","default":false},"imageID":{"type":"string"},"imageURL":{"type":"string"},"iconTypeSelect":{"type":"string","default":"icon"},"selectedIcon":{"type":"string","default":"dashicons admin-site"},"lottieURl":{"type":"string"},"loop":{"type":"boolean","default":true},"reversedir":{"type":"boolean","default":false},"svgUrl":{"type":"string","default":""},"icons":{"type":"array","default":[{"size":"50","width":"2","title":"","style":"default"}]}},"editorScript":"pbg-blocks-js","editorStyle":"premium-blocks-editor-css"}');
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"version":"0.1.0","name":"premium/form-toggle","title":"Form Toggle","description":"Create a form toggle.","category":"premium-blocks","keywords":["toggle"],"parent":["premium/form","premium/container","premium/section"],"attributes":{"blockId":{"type":"string"},"required":{"type":"boolean","default":false},"label":{"type":"string","default":"Toggle"},"value":{"type":"string","default":""},"name":{"type":"string"},"onState":{"type":"string","default":"On"},"offState":{"type":"string","default":"Off"},"defaultState":{"type":"boolean","default":false},"style":{"type":"string","default":"rounded"}},"editorScript":"pbg-blocks-js","editorStyle":"premium-blocks-editor-css"}');
      ...
      switch (blockName) {
        ...
        case 'premium/form-checkbox':
          ...
          if (required && !checked.length) {
            addInputError(checkboxsContainer, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Please select a %s.', 'premium-blocks-for-gutenberg'), checkboxLabel));
            errors.push(name);
            // Skip.
            break;
          }
        ...
        case 'premium/form-toggle':
          ...
          if (required && !fieldToggle.checked) {
            addInputError(toggleField, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Please check the %s.', 'premium-blocks-for-gutenberg'), fieldToggleLabel));
            errors.push(name);
            // Skip.
            break;
          }
        ...
        case 'premium/form-accept':
          ...
          if (required && !fieldAccept.checked) {
            ...
            addInputError(acceptParent, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Please check the %s.', 'premium-blocks-for-gutenberg'), fieldAcceptLabel));
            errors.push(name);
            // Skip.
            break;
          }
